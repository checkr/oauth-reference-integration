...
// When your user wishes to sign-up with Checkr. They will click your
...
// Checkr will redirect your user to this endpoint.
oauthRouter.get('/api/checkr/oauth', async (req, res) => {
  ...
  //   that you can use to identify which user is setting up a Checkr
  //   account.
  ...
  //
  //     {
  //       access_token: <access token for the user's account>,
...
oauthRouter.post('/api/checkr/webhooks', async (req, res) => {
  ...
  switch (req.body.type) {
    ...
    // user wishes to disable you from making background checks on their behalf.
    ...
    case 'token.deauthorized':
      ...
      // Find the user with an access token that matches this
      // ```access_code``` value, and register this user's Checkr Account
      // as deauthorized.
...
// <mark>All Checkr integrations are required to allow their user to deauthorize
